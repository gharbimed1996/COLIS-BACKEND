...
public class Admin {
    ...
    private static final Logger LOG = org.slf4j.LoggerFactory.getLogger(Admin.class);



    @PostMapping("/create")
    public String createuser(@RequestBody AdminDTO adminDTO) {

        return userService.addAdminOrg(adminDTO);
    }
    @PostMapping("/login")
