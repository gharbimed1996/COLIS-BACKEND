...
public class DemandeCreatedEvent extends BaseEvent<String> {
    ...
    public DemandeCreatedEvent(String id, String adresse, String nom, Long numTel, String email, String description, DemandeStatus status) {
        super(id);
