...
public class ColisCreatedEvent extends BaseEvent<String> {
    @Getter private String matricule;
    @Getter private String description;
    @Getter private boolean fragile;
    @Getter private ColisStatus status;

    public ColisCreatedEvent(String id, String matricule, String description, boolean fragile, ColisStatus status) {
        super(id);
