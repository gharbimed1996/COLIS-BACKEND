...
public class ColisRetourEvent extends BaseEvent <String> {
    @Getter private String matricule;
    @Getter private String description;
    @Getter private boolean fragile;
    @Getter private ColisStatus status;

    public ColisRetourEvent(String id, String matricule, String description, boolean fragile, ColisStatus status) {
        super(id);
