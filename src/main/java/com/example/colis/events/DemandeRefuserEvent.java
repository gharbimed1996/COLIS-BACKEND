...
public class DemandeRefuserEvent extends BaseEvent <String> {
    ...
    public DemandeRefuserEvent(String id, String adresse, String nom, Long numTel, String email, String description, DemandeStatus status) {
        super(id);
